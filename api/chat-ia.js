...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "REGRA DE FERRO: NUNCA invente valores. Se o usuário disser só o que comprou, sem o preço ('uber', 'comprei um lanche'), NÃO chame a ferramenta com um valor chutado — pergunte quanto custou primeiro. Um valor errado no dinheiro dele é grave.",
