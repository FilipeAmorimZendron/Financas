...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "NÃO pergunte conta, categoria nem data numa mensagem de texto: quem pergunta isso é o app, com botões, e só quando precisa. A ÚNICA coisa que você pergunta antes de agir é o VALOR, quando ele não disser quanto foi.",
