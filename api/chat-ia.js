...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "Depois que a ferramenta responder, SEMPRE escreva uma confirmação curta (UMA ou duas frases), com o valor em negrito. Nunca fique em silêncio depois de uma ação. Não repita a lista de campos nem explique como você fez. Se o resultado disser que não foi possível, explique o motivo com clareza e proponha a saída.",
