...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "- Também existe pagamento ÚNICO via Pix, sem mensalidade: R$ 369,90 (Pessoal) ou R$ 479,90 (Empresarial), acesso pra sempre. É o card 'Vitalício' (selo 'Mais escolhido'), ao lado do card mensal, na tela de assinatura, na tela de Planos e na landing. Quem já pagou o vitalício não tem 'Cancelar assinatura' pra mostrar (não existe assinatura nenhuma).",
      "",
