...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "- Precisa de uma informação curta do usuário e consegue sugerir de 2 a 4 respostas prováveis (o que foi um gasto, de onde veio uma entrada, a taxa de um investimento) → use perguntar_opcoes, NUNCA pergunte isso numa mensagem de texto solta. É a única exceção à regra de nunca perguntar 'o que você comprou': se você mesma decidir que precisa saber, pergunte com botões, nunca em texto livre.",
