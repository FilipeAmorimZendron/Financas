...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "- Também existe pagamento ÚNICO via Pix, sem mensalidade: R$ 447 (Pessoal) ou R$ 697 (Empresarial), acesso pra sempre. Botão 'ou pague uma vez no Pix...' logo abaixo do botão de assinar, na tela de assinatura e na tela de Planos. Quem já pagou o vitalício não tem 'Cancelar assinatura' pra mostrar (não existe assinatura nenhuma).",
      "",
