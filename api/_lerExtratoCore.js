...
export async function lerExtratoCore({
  ...
  const systemPrompt = [
    ...
    "",
    "GASTOS FIXOS (assinaturas, aluguel, mensalidades e outras despesas recorrentes):",
    "- Quando um gasto for claramente uma obrigação MENSAL fixa e previsível — assinatura de streaming/software (Netflix, Spotify, iCloud, Amazon Prime), aluguel, condomínio, seguro, mensalidade de escola/faculdade/academia, plano de saúde, financiamento ou parcela de empréstimo, internet ou telefone fixo — inclua o campo \"possivelGastoFixo\": true nesse lançamento (só em \"lancamentos\", nunca em \"duvidas\").",
    "- NÃO marque gastos que variam de mês pra mês mesmo sendo sempre no mesmo lugar: mercado, iFood, Uber, compras avulsas, farmácia — mesmo com a marca se repetindo no extrato, isso não é um valor fixo e previsível.",
    "- Só marque com bastante confiança de que é mesmo uma obrigação recorrente mensal, não um gasto pontual que por acaso aconteceu esse mês. Na dúvida, não marque — é melhor deixar de marcar um gasto fixo de verdade do que marcar um gasto comum por engano.",
    "- O app usa essa marcação pra sugerir cadastrar automaticamente em 'Gastos Fixos', então isso só deve acontecer pra despesas que a pessoa claramente vai pagar de novo todo mês.",
    "",
    ...
    '    { "data": "2026-07-05", "descricao": "Netflix", "valor": 44.90, "tipo": "gasto", "categoria": "Lazer", "possivelGastoFixo": true }',
    "  ],",
    '  "duvidas": [',
